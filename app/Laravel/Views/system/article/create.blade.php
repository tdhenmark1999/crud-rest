  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="panel panel-default panel-border-color panel-border-color-success">
        <div class="panel-heading panel-heading-divider">Create Record Form<span class="panel-subtitle">Event information.</span></div>
        <div class="panel-body">
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group {{$errors->first('linked_url') ? 'has-error' : NULL}}">
              ...
              <input type="text" placeholder="URL of the Event eg." class="form-control" name="linked_url" value="{{old('linked_url')}}">
