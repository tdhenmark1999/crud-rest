  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="panel panel-default panel-border-color panel-border-color-success">
        <div class="panel-heading panel-heading-divider">Update Record Form<span class="panel-subtitle">News information.</span></div>
        <div class="panel-body">
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <img src="{{"{$news->directory}/resized/$news->filename"}}" alt="" class="img-thumbnail"  width="200" height="200">
            </div>
            @endif
            <div class="form-group {{$errors->first('title') ? 'has-error' : NULL}}">
              <label>Title</label>
              <input type="text" placeholder="Title of the news" class="form-control" name="title" value="{{old('title',$news->title)}}">
...
{{-- 
            ...
            <div class="form-group {{$errors->first('linked_url') ? 'has-error' : NULL}}">
              ...
              <input type="text" placeholder="URL of the news eg. https://youtu.be/C0DPdy98e4c" class="form-control" name="linked_url" value="{{old('linked_url',$news->linked_url)}}">
           ...
           {{--  <div class="form-group {{$errors->first('content') ? 'has-error' : NULL}}">
              <label>Content</label>
              <textarea name="content" id="content" cols="30" rows="10" class="form-control editor">{!!old('content',$news->content)!!}</textarea>
